...
(define-resource zitting ()
  ...
  :has-many `((mandataris :via ,(s-prefix "besluit:heeftAanwezigeBijStart")
              ...
              (agendapunt :via ,(s-prefix "besluit:behandelt")
                          :as "agendapunten")
              (behandeling-van-agendapunt :via ,(s-prefix "ext:besluitPublicatieLinkedBvap")
                                          :as "behandeling-van-agendapunten")
              (besluit :via ,(s-prefix "ext:besluitPublicatieLinkedBesluit")
                       :as "besluiten"))
